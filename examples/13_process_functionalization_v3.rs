...
const SAVE_PARQUET_DIR:&str = "D:/data/processed/240903_m3_9_displacement/13_process_functionalization_v3/";
...
fn make_deviation_first_plot_png(df:&DataFrame,save_file_path:&str ,y_axis_max:f64)->Result<()>{
    ...
    let caption = "シール毎のエッジの位置 先頭200袋";
